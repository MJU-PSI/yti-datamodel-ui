...
@Component({
  selector: 'contributors-view',
  template: `
      <h4>
        <span translate>Contributors</span>
        <button id="add_contributor_button" type="button" class="btn btn-link btn-xs pull-right" (click)="addContributor()" *ngIf="isEditing()">
          <span translate>Add contributor</span>
        </button>
...
export class ContributorsTableDescriptor extends TableDescriptor<Organization> {
