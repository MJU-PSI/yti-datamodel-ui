...
import { Class } from 'app/entities/class';
import { Predicate } from 'app/entities/predicate';
import { HistoryModelModal } from './history-model-modal';

@Component({
  selector: 'history-model',
  template: `
...
export class HistoryModelComponent {

  @Input() model: Model;
  @Input() resource: Class | Predicate | Model;
  @Input() buttonId?: string;

  constructor(private historyModal: HistoryModelModal) {}
