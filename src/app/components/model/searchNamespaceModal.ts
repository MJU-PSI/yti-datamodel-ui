...
@Component({
  selector: 'app-search-namespace-modal',
  templateUrl: './searchNamespaceModal.html'
})
export class SearchNamespaceModalComponent implements SearchController<ImportedNamespace> {
  searchResults: ImportedNamespace[];
  namespaces: ImportedNamespace[];
  searchText = '';
  showTechnical: boolean;
  ...
  onShowTechnicalChange(newValue: boolean) {
    this.search();
  }
