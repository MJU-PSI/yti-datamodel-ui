...
@Component({
  ...
  templateUrl: './newModelPage.html'
})
export class NewModelPageComponent implements OnInit {
  ...
  isValid() {
    return this.form && this.form.valid && this.classifications.length > 0 && this.contributors.length > 0;
  }
