...
export interface InputWithPopupController<T> {
  ...
  isSelected(index: number): boolean;
  setSelection(index: number): void;
  selectSelection(event?: Event): void;
}
...
@Directive({
  selector: 'input-popup-item-trnsclude,[input-popup-item-trnsclude]',
})
export class InputPopupItemTranscludeDirective {

}


@Directive({
  selector: 'input-popup-delect-item,[input-popup-delect-item]',
})
export class InputPopupSelectItemDirective {
