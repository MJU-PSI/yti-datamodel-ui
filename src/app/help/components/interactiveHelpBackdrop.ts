...
// import { assertNever, Optional } from '@mju-psi/yti-common-ui';
...
@Component({
  selector: 'app-interactive-help-backdrop',
  template: `
    <div *ngIf="regions" class="help-backdrop" [ngStyle]="regions.top"></div>
    <div *ngIf="regions" class="help-backdrop" [ngStyle]="regions.right"></div>
    <div *ngIf="regions" class="help-backdrop" [ngStyle]="regions.bottom"></div>
    <div *ngIf="regions" class="help-backdrop" [ngStyle]="regions.left"></div>
  `
})
export class InteractiveHelpBackdropComponent {
  ...
  private resolveRegions(item: Story|Notification): Optional<Regions> {
    switch (item.type) {
      case 'story':
        return InteractiveHelpBackdropComponent.calculateRegions(item, this.document.body.clientWidth);
      case 'notification':
        return InteractiveHelpBackdropComponent.fullBackdrop;
      default:
        return assertNever(item, 'Unknown item type');
