...
export class EntityCreatorService {
  ...
  createModel(details: ModelDetails): Promise<Model> {
    ...
    return Promise.resolve(new Model(graph, context, null));
  }

  createImportedNamespaces(detailsList: (ImportedExternalNamespaceDetails|Model)[]): Promise<ImportedNamespace[]> {
    const promises = detailsList.map(details => this.createImportedNamespace(details));
    return Promise.all(promises);
  }

  createImportedNamespace(details: ImportedExternalNamespaceDetails|Model): Promise<ImportedNamespace> {
    ...
    return Promise.resolve(new ImportedNamespace(graph, context, null));
  }
  ...
  createOrganization(details: OrganizationDetails): Promise<Organization> {
    ...
    return Promise.resolve(new Organization(graph, context, null));
  }

  createPredicate(details: PredicateDetails): Promise<Predicate> {
    ...
    return Promise.resolve(details.type === 'attribute' ? new Attribute(graph, context, null)
                                                     : new Association(graph, context, null));
  }

  createClass(details: ClassDetails): Promise<Class> {
    ...
    return Promise.resolve(new Class(graph, context, null));
  }

  createShape(klass: Class, profile: Model): Promise<Class> {
  ...
  createProperty(details: PropertyDetails): Promise<Property> {
    ...
    return Promise.resolve(new Property(graph, context, null));
  }

  createVocabulary(details: VocabularyDetails): Promise<Vocabulary> {
    ...
    return Promise.resolve(new Vocabulary(graph, terminologyContext, null));
  }

  createConcept(details: ConceptDetails): Promise<Concept> {
    ...
    return Promise.resolve(new Concept(graph, terminologyContext, null));
  }
}
