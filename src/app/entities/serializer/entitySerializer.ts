import { assertNever, isDefined, normalizeAsArray } from '@mju-psi/yti-common-ui';
...
export function entityAwareOptional<T, N extends WithContextAndFrame>(entitySerializer: EntityAwareSerializer<T, N>,
                                                                      isDefinedFn: (data: T|null|undefined) => boolean = isDefined): EntityAwareSerializer<T|null, N> {
  return createEntityAwareSerializer(
...
export function entityAwareValueOrDefault<T, N extends WithContextAndFrame>(entitySerializer: EntityAwareSerializer<T, N>,
                                                                            defaultData: any,
                                                                            isDefinedFn: (data: T|null|undefined) => boolean = isDefined): EntityAwareSerializer<T, N> {
  return createEntityAwareSerializer(
...
export function entityAwareMap<T extends WithIdAndType, N extends WithContextAndFrame>(entitySerializer: EntityAwareSerializer<T, N>): EntityAwareSerializer<Map<string, T>, N> {
  return createEntityAwareSerializer(
...
export function entityOrId<T extends GraphNode, N extends WithContextAndFrame>(entitySerializer: EntityAwareSerializer<T, N>): EntityAwareSerializer<T|Uri, N> {
  return createEntityAwareSerializer(
...
export function normalized<T, N extends { context: any, frame: any }>(entitySerializer: EntityAwareSerializer<T, N>,
                                                                      normalizer: (data: any, instance: N) => any): EntityAwareSerializer<T, N> {
  return createEntityAwareSerializer(
